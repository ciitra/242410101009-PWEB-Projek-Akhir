...
<section class="customer-create-reservasi-page">
    ...
    <section class="customer-create-hero">
        <div>
            <span class="customer-create-kicker">Owner Area</span>

            <h1>Edit Reservasi Pelanggan</h1>
        </div>

        <a href="{{ route('reservasi.show', $reservasi->id) }}" class="customer-create-back">
            Kembali
        </a>
    </section>
    ...
    <form action="{{ route('reservasi.update', $reservasi->id) }}" method="POST" class="customer-create-form">
        @csrf
        @method('PUT')
            ...
            <div class="customer-create-grid">
                ...
                <div class="customer-create-group">
                    ...
                    <input
                        ...
                        readonly
                    >
                    <small class="customer-create-help">
                        Status pembayaran diubah melalui halaman detail reservasi.
                    </small>
                </div>
            </div>
        </section>
        ...
        <section class="customer-create-card">
            ...
            <div class="customer-package-preview" id="packagePreview">
                ...
                <strong>{{ $reservasi->paket_foto }} - Rp{{ number_format($reservasi->harga, 0, ',', '.') }}</strong>
                <p>Detail paket akan diperbarui otomatis ketika paket foto diganti.</p>
            </div>
        </section>
        ...
        <section class="customer-create-card">
            <div class="customer-create-card-head">
                ...
                <div>
                    <span class="customer-create-kicker">Langkah 4</span>
            ...
            @php
                $tanggalDipilih = old(
                    ...
                    is_object($reservasi->tanggal_reservasi)
                        ...
                        : date('Y-m-d', strtotime($reservasi->tanggal_reservasi))
                );
            ...
            <div class="customer-create-grid">
                ...
                <div class="customer-create-group">
                    ...
                    <select name="jam_reservasi" id="jam_reservasi" class="{{ $errors->has('jam_reservasi') ? 'input-error' : '' }}">
                        ...
                        <option value="08:00" {{ $jamDipilih == '08:00' ? 'selected' : '' }}>08:00 - 08:30</option>
                        <option value="08:30" {{ $jamDipilih == '08:30' ? 'selected' : '' }}>08:30 - 09:00</option>
                        <option value="09:00" {{ $jamDipilih == '09:00' ? 'selected' : '' }}>09:00 - 09:30</option>
                        <option value="09:30" {{ $jamDipilih == '09:30' ? 'selected' : '' }}>09:30 - 10:00</option>
                        <option value="10:00" {{ $jamDipilih == '10:00' ? 'selected' : '' }}>10:00 - 10:30</option>
                        <option value="10:30" {{ $jamDipilih == '10:30' ? 'selected' : '' }}>10:30 - 11:00</option>
                        <option value="11:00" {{ $jamDipilih == '11:00' ? 'selected' : '' }}>11:00 - 11:30</option>
                        <option value="11:30" {{ $jamDipilih == '11:30' ? 'selected' : '' }}>11:30 - 12:00</option>
                        <option value="12:00" {{ $jamDipilih == '12:00' ? 'selected' : '' }}>12:00 - 12:30</option>
                        <option value="12:30" {{ $jamDipilih == '12:30' ? 'selected' : '' }}>12:30 - 13:00</option>
                        <option value="13:00" {{ $jamDipilih == '13:00' ? 'selected' : '' }}>13:00 - 13:30</option>
                        <option value="13:30" {{ $jamDipilih == '13:30' ? 'selected' : '' }}>13:30 - 14:00</option>
                        <option value="14:00" {{ $jamDipilih == '14:00' ? 'selected' : '' }}>14:00 - 14:30</option>
                        <option value="14:30" {{ $jamDipilih == '14:30' ? 'selected' : '' }}>14:30 - 15:00</option>
                        <option value="15:00" {{ $jamDipilih == '15:00' ? 'selected' : '' }}>15:00 - 15:30</option>
                        <option value="15:30" {{ $jamDipilih == '15:30' ? 'selected' : '' }}>15:30 - 16:00</option>
                        <option value="16:00" {{ $jamDipilih == '16:00' ? 'selected' : '' }}>16:00 - 16:30</option>
                        <option value="16:30" {{ $jamDipilih == '16:30' ? 'selected' : '' }}>16:30 - 17:00</option>
                        <option value="17:00" {{ $jamDipilih == '17:00' ? 'selected' : '' }}>17:00 - 17:30</option>
                        <option value="17:30" {{ $jamDipilih == '17:30' ? 'selected' : '' }}>17:30 - 18:00</option>
                        <option value="18:00" {{ $jamDipilih == '18:00' ? 'selected' : '' }}>18:00 - 18:30</option>
                        <option value="18:30" {{ $jamDipilih == '18:30' ? 'selected' : '' }}>18:30 - 19:00</option>
                        <option value="19:00" {{ $jamDipilih == '19:00' ? 'selected' : '' }}>19:00 - 19:30</option>
                        <option value="19:30" {{ $jamDipilih == '19:30' ? 'selected' : '' }}>19:30 - 20:00</option>
                        <option value="20:00" {{ $jamDipilih == '20:00' ? 'selected' : '' }}>20:00 - 20:30</option>
                        <option value="20:30" {{ $jamDipilih == '20:30' ? 'selected' : '' }}>20:30 - 21:00</option>
                    </select>
        ...
        <div class="customer-create-actions">
            <a href="{{ route('reservasi.show', $reservasi->id) }}" class="customer-create-cancel">
                Batal
            </a>
            ...
            if (daftarHarga[paketDipilih]) {
                ...
                if (packagePreview) {
                    packagePreview.innerHTML = `
                        ...
                        <p>Detail singkat paket akan muncul setelah memilih paket foto.</p>
                    `;
                }
            }
        }
