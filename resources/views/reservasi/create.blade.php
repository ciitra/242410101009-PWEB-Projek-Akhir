...
<section class="customer-create-reservasi-page">
    ...
    <section class="customer-create-hero">
        <div>
            ...
            <h1>Tambah Reservasi Pelanggan</h1>

            <p>
                Tambahkan data booking pelanggan secara manual, pilih paket foto,
                dan atur jadwal pemotretan. Pembayaran reservasi dari owner akan
                otomatis ditandai lunas.
            </p>
        </div>

        <a href="{{ route('reservasi.index') }}" class="customer-create-back">
            Kembali
        </a>
    </section>
    ...
    @if ($errors->any())
        <div class="customer-create-alert">
            <strong>Reservasi belum berhasil ditambahkan.</strong>
    ...
    <form action="{{ route('reservasi.store') }}" method="POST" class="customer-create-form">
        @csrf
        ...
        <section class="customer-create-card">
            <div class="customer-create-card-head">
                ...
                <div>
                    ...
                    <h2>Data Booking</h2>
                    <p>
                        Masukkan kode booking reservasi pelanggan. Status pembayaran
                        akan otomatis menjadi lunas karena dibuat oleh owner.
                    </p>
                </div>
            </div>
            ...
            <div class="customer-create-grid">
                <div class="customer-create-group">
                    ...
                    <input
                        ...
                        name="kode_booking"
                        id="kode_booking"
                        placeholder="Contoh: OWN-20260607-1234"
                ...
                <div class="customer-create-group">
                    ...
                    <input
                        type="text"
                        value="Lunas - Manual Owner"
                        readonly
                    >
                    <small class="customer-create-help">
                        Reservasi yang dibuat owner otomatis dianggap sudah lunas.
                    </small>
                </div>
            </div>
        </section>
        ...
        <section class="customer-create-card">
            <div class="customer-create-card-head">
                ...
                <div>
                    ...
                    <p>Pilih tanggal dan jam reservasi. Slot yang sudah dibooking tidak dapat dipilih lagi.</p>
                </div>
            </div>
        ...
        <div class="customer-create-actions">
            <a href="{{ route('reservasi.index') }}" class="customer-create-cancel">
                Batal
            </a>
